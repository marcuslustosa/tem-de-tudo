...
try {
    ...
    $empresasData = [
        ['nome' => 'Restaurante Sabor da Terra', 'ramo' => 'restaurante', 'multiplier' => 1.5],
        ['nome' => 'Academia FitLife', 'ramo' => 'academia', 'multiplier' => 2.0],
        ['nome' => 'Café Aroma & Sabor', 'ramo' => 'cafeteria', 'multiplier' => 1.2],
        ['nome' => 'Pet Shop Bicho Feliz', 'ramo' => 'pet_shop', 'multiplier' => 1.3],
        ['nome' => 'Salão Beleza Pura', 'ramo' => 'salao', 'multiplier' => 1.8],
        ['nome' => 'Mercado Bom Preço', 'ramo' => 'mercado', 'multiplier' => 1.0],
        ['nome' => 'Farmácia Saúde Total', 'ramo' => 'farmacia', 'multiplier' => 1.4],
        ['nome' => 'Pizzaria Bella Napoli', 'ramo' => 'restaurante', 'multiplier' => 1.5],
        ['nome' => 'Churrascaria Boi na Brasa', 'ramo' => 'restaurante', 'multiplier' => 1.6],
        ['nome' => 'Hamburgueria Top Burger', 'ramo' => 'restaurante', 'multiplier' => 1.3],
        ['nome' => 'Sushi Bar Sakura', 'ramo' => 'restaurante', 'multiplier' => 1.7],
        ['nome' => 'Padaria Pão Quente', 'ramo' => 'padaria', 'multiplier' => 1.1],
        ['nome' => 'Lanchonete da Esquina', 'ramo' => 'lanchonete', 'multiplier' => 1.2],
        ['nome' => 'Sorveteria Gelato Italiano', 'ramo' => 'sorveteria', 'multiplier' => 1.4],
        ['nome' => 'Açaí & Cia', 'ramo' => 'sorveteria', 'multiplier' => 1.3],
        ['nome' => 'Lavanderia Express Clean', 'ramo' => 'lavanderia', 'multiplier' => 1.2],
        ['nome' => 'Auto Center Speed', 'ramo' => 'auto_center', 'multiplier' => 1.8],
        ['nome' => 'Ótica Visão Clara', 'ramo' => 'otica', 'multiplier' => 1.5],
        ['nome' => 'Livraria Ler & Saber', 'ramo' => 'livraria', 'multiplier' => 1.3],
        ['nome' => 'Papelaria Office Plus', 'ramo' => 'papelaria', 'multiplier' => 1.1]
    ];
