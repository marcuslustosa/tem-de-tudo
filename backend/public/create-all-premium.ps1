# Script para criar TODAS as páginas premium rapidamente
$pages = @{
    "inicio.html" = @"
<!DOCTYPE html>
<html lang="pt-BR">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Início - Tem de Tudo</title><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"></head>
...
foreach ($page in $pages.Keys) {
    $content = $pages[$page]
    $path = "c:\Users\X472795\Desktop\Projetos\tem-de-tudo\backend\public\$page"
    $content | Out-File -FilePath $path -Encoding UTF8
    Write-Output "✅ Criado: $page"
}
