...
Route::get('/_diag/schema', function (\Illuminate\Http\Request $request) {
    ...
    $expectedCols = json_decode('{"admins":["id","nome","email","telefone","password","nivel","empresa","cnpj","permissoes","criado_por","status","senha_temporaria","ultimo_login","ip_ultimo_login","remember_token","created_at","updated_at"],"ajustes_pontos":["id","user_id","admin_id","pontos","motivo","created_at","updated_at"],"audit_logs":["id","user_id","admin_id","action","ip_address","user_agent","details","created_at"],"avaliacoes":["id","user_id","empresa_id","estrelas","comentario","created_at","updated_at"],"badges":["id","nome","descricao","icone","cor","condicao_tipo","condicao_valor","ativo","ordem","created_at","updated_at"],"banners":["id","title","image_url","link","active","position","starts_at","ends_at","payload","created_at","updated_at"],"billing_events":["id","company_id","subscription_id","invoice_id","event_type","level","payload","occurred_at","created_at","updated_at"],"billing_notifications":["id","invoice_id","company_id","type","channel","sent","sent_at","error","created_at","updated_at"],"bonus_adesao":["id","empresa_id","titulo","descricao","tipo_desconto","valor_desconto","imagem","ativo","created_at","updated_at","data_expiracao","limite_por_cliente","tipo","ordem","termos"],"bonus_adesao_resgates":["id","user_id","empresa_id","pontos","resgatado","data_resgate","created_at","updated_at","bonus_id","status","validated_by","redeemed_at"],"bonus_aniversario":["id","empresa_id","titulo","descricao","presente","imagem","ativo","created_at","updated_at","dias_validade","notification_title","notification_body"],"bonus_aniversario_resgates":["id","bonus_aniversario_id","empresa_id","user_id","ano","status","redeemed_at","validated_by","created_at","updated_at"],"bonus_aniversarios":["id","user_id","pontos","data_resgate","ano","created_at","updated_at"],"campanhas_multiplicador":["id","empresa_id","nome","descricao","multiplicador","data_inicio","data_fim","ativo","created_at","updated_at"],"cartao_fidelidades":["id","user_id","categoria","carimbos_atual","carimbos_necessarios","validade","created_at","updated_at"],"cartoes_fidelidade":["id","empresa_id","titulo","descricao","meta_pontos","recompensa","ativo","created_at","updated_at","regra_ganho","pontos_por_visita","pontos_necessarios","recompensa_descricao","data_expiracao"],"cartoes_fidelidade_movimentos":["id","cartao_fidelidade_id","empresa_id","user_id","pontos","tipo","descricao","created_by","created_at","updated_at"],"cartoes_fidelidade_progresso":["id","user_id","cartao_fidelidade_id","pontos_atuais","vezes_resgatado","ultimo_ponto","created_at","updated_at"],"categorias":["id","name","slug","active","position","created_at","updated_at"],"check_ins":["id","user_id","empresa_id","qr_code_id","valor_compra","pontos_calculados","foto_cupom","latitude","longitude","observacoes","status","codigo_validacao","aprovado_em","aprovado_por","rejeitado_em","rejeitado_por","motivo_rejeicao","bonus_applied","created_at","updated_at","pontos","data","pontos_ganhos","pontos_base","multiplicador","detalhes_calculo"],"company_loyalty_configs":["id","company_id","points_per_real","scan_base_points","redeem_points_per_currency","min_redeem_points","welcome_bonus_points","is_active","metadata","created_by","updated_by","created_at","updated_at"],"coupons":["id","user_id","empresa_id","checkin_id","codigo","tipo","descricao","custo_pontos","valor_desconto","porcentagem_desconto","status","expira_em","usado_em","dados_extra","created_at","updated_at"],"data_privacy_requests":["id","user_id","request_type","status","reason","file_path","payload","requested_ip","requested_user_agent","requested_at","processed_at","created_at","updated_at"],"desafio_progresso":["id","user_id","desafio_id","progresso_atual","concluido","concluido_em","recompensa_dada","created_at","updated_at"],"desafios":["id","empresa_id","nome","descricao","tipo","meta","recompensa_pontos","recompensa_descricao","data_inicio","data_fim","ativo","created_at","updated_at"],"device_fingerprints":["id","device_id","fingerprint_hash","user_id","status","device_info","last_ip","last_lat","last_long","first_seen","last_seen","transaction_count","created_at","updated_at"],"discount_levels":["id","empresa_id","points_required","discount_percentage","title","description","is_active","applies_to_all_products","applies_to_all_services","specific_categories","created_at","updated_at"],"empresas":["id","nome","endereco","telefone","cnpj","logo","descricao","points_multiplier","ativo","owner_id","created_at","updated_at","ramo","whatsapp","instagram","facebook","avaliacao_media","total_avaliacoes","status","categoria","rede_compartilhada","rede_nome"],"fraud_alerts":["id","user_id","device_id","rule_id","alert_type","risk_score","status","context","details","action_taken","reviewed_by","reviewed_at","created_at","updated_at"],"fraud_blacklist":["id","type","value","reason","added_by","expires_at","created_at","updated_at"],"fraud_rules":["id","name","description","rule_type","config","is_active","severity","action","created_at","updated_at"],"historicos":["id","user_id","acao","data","detalhes"],"inscricoes_empresa":["id","user_id","empresa_id","data_inscricao","ultima_visita","bonus_adesao_resgatado","created_at","updated_at"],"invoices":["id","subscription_id","company_id","invoice_number","amount_cents","discount_cents","total_cents","status","due_date","paid_at","payment_method","payment_id","payment_url","payment_metadata","notes","created_at","updated_at","retry_count","last_retry_at","next_retry_at","last_failure_reason","reconciliation_status","external_status","reconciled_at"],"ledger":["id","idempotency_key","user_id","company_id","transaction_type","points","balance_before","balance_after","description","metadata","related_ledger_id","source","created_by","created_at"],"lembrete_envios":["id","lembrete_id","empresa_id","user_id","sent_at","reference_last_visit_at","status","erro","created_at","updated_at"],"lembretes_ausencia":["id","empresa_id","dias_ausencia","titulo","mensagem","ativo","created_at","updated_at","dias_sem_visita","imagem_url","notification_title","notification_body"],"notificacoes_push":["id","user_id","empresa_id","tipo","titulo","mensagem","imagem","enviado","data_envio","created_at","updated_at","promocao_id","status","erro","bonus_aniversario_id","lembrete_id"],"notifications":["id","user_id","title","message","type","payload","read_at","created_at","updated_at"],"nps_respostas":["id","user_id","empresa_id","promocao_id","nota","comentario","contexto","created_at","updated_at"],"pagamentos":["id","user_id","empresa_id","produto_id","mercadopago_payment_id","status","valor","valor_desconto","valor_final","pontos_gerados","metodo_pagamento","detalhes_pagamento","qr_code_data","link_pagamento","data_expiracao","webhook_events","created_at","updated_at"],"password_reset_tokens":["email","token","created_at"],"personal_access_tokens":["id","tokenable_type","tokenable_id","name","token","abilities","last_used_at","expires_at","created_at","updated_at"],"ponto_transacoes":["id","user_id","pontos","tipo","descricao","valor_compra","estabelecimento_id","created_at","updated_at"],"pontos":["id","user_id","empresa_id","checkin_id","coupon_id","pontos","descricao","tipo","created_at","updated_at","expirado","expired_at"],"produtos":["id","empresa_id","nome","descricao","preco","categoria","imagem","ativo","estoque","pontos_gerados","created_at","updated_at"],"promocao_resgates":["id","promocao_id","empresa_id","user_id","status","redeemed_at","validated_by","created_at","updated_at"],"promocoes":["id","empresa_id","titulo","descricao","imagem","pontos_necessarios","desconto_percentual","desconto_valor","validade","quantidade_disponivel","termos_condicoes","ativo","data_envio","total_envios","created_at","updated_at","desconto","data_inicio","status","visualizacoes","resgates","usos","notification_title","notification_body","qtd_disponivel","qtd_resgatada","limite_por_usuario"],"push_notifications":["id","user_id","admin_id","user_type","title","body","data","type","fcm_token","is_sent","sent_at","read_at","error_message","created_at","updated_at"],"push_subscriptions":["id","user_id","endpoint","p256dh","auth","user_agent","ip","created_at","updated_at","public_key","auth_token","content_encoding","device_type","last_seen_at","revoked_at"],"qr_codes":["id","empresa_id","name","code","location","active","active_offers","usage_count","last_used_at","created_at","updated_at","qr_path"],"redemption_intents":["id","intent_id","user_id","company_id","reserved_ledger_id","confirmed_ledger_id","reversal_ledger_id","points_requested","points_confirmed","status","redemption_type","metadata","pdv_operator_id","pdv_terminal_id","requested_at","reserved_at","confirmed_at","canceled_at","reversed_at","expires_at","cancellation_reason","reversal_reason","reversed_by","created_at","updated_at"],"segmento_usuarios":["id","segmento_id","user_id","adicionado_em"],"segmentos":["id","nome","descricao","criterios","ativo","created_at","updated_at"],"subscription_plans":["id","name","display_name","description","monthly_price_cents","features","max_users","max_transactions_per_month","trial_days","is_active","created_at","updated_at"],"subscriptions":["id","company_id","subscription_plan_id","status","started_at","trial_ends_at","current_period_start","current_period_end","canceled_at","cancellation_reason","billing_day","grace_period_days","created_at","updated_at"],"user_badges":["id","user_id","badge_id","conquistado_em","created_at","updated_at"],"users":["id","name","email","email_verified_at","password","perfil","telefone","status","remember_token","created_at","updated_at","role","nivel","nivel_acesso","permissions","is_active","pontos","pontos_lifetime","valor_gasto_total","dias_consecutivos","ultimo_checkin","empresas_visitadas","multiplicador_pontos","posicao_ranking","data_nascimento","fcm_token","latitude","longitude","referral_code","referred_by","streak_atual","streak_maximo","terms_accepted_at","privacy_policy_accepted_at","data_processing_consent_at","marketing_consent","consent_version"],"webhook_logs":["id","webhook_id","evento","payload","status_http","resposta","sucesso","tentativas","enviado_em"],"webhooks_saida":["id","empresa_id","url","segredo","eventos","ativo","created_at","updated_at"]}', true);
    $missingColumns = [];
    foreach ($expectedCols as $t => $cols) {
        if (!\Illuminate\Support\Facades\Schema::hasTable($t)) { continue; }
        try {
            $have = \Illuminate\Support\Facades\Schema::getColumnListing($t);
            $gap = array_values(array_diff($cols, $have));
            if (!empty($gap)) { $missingColumns[$t] = $gap; }
        } catch (\Throwable $e) {
